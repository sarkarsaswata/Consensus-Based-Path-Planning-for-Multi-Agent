                            ...
                            if line.intersects(line2):
                                ...
                                if abs(dist1 - dist2) < threshold_radius:
                                    ...
                                    if ((cost_old - cost_new)/cost_old)*100 >=5:
                                        ...
                                        # agent_direction = calculate_direction_vector(agents[i], tasks[j2])
                                        # updated_direction = adjust_agent_direction(agent_direction, inter_point, threshold_radius)
                                        # # print("for agent",i,updated_direction)
                                        # agent_direction2 = calculate_direction_vector(agents[i2], tasks[j])
                                        # updated_direction2 = adjust_agent_direction(agent_direction2, inter_point, threshold_radius)
                                        # print("for agent",i2,updated_direction2)
